                    ...
                    <Col>
                        <Card className="shadow">
                                            ...
                                            <Col className="col-12 border-0">
                                                <Row >
                                                    <Col lg="12" style={{
                                                        ...
                                                        <small>{moment(f, "YYYY-MM-DD").format("ll")}</small>
                                                    </Col>
                                                </Row>
                                            </Col>
                                            <Col className="col-12 border-0 my-1">
                                                <Row>
                                                    {
                                                        reservationList?.data?.filter(rl => rl.fecha === f)?.map((r, i) =>
                                                            <Col key={i} className="col-12 py-3 selectable-row"
                                                            ...
                                                            >
                                                                ...
                                                                <Collapse isOpen={isopen[r.idReserva]}>
                                                                    <Row>
                                                                        <div className="col-12 d-flex justify-content-between mx-auto mt-4 mb-1">
                                                                            {r.tipo === 2 ?
                                                                                r.gratuito ?
                                                                                    <div>
                                                                                        <strong className="mr-3"><span><i className="ni ni-check-bold text-success mr-2"></i>Gratuito</span></strong>
                                                                                    </div>
                                                                                    :
                                                                                    <div>
                                                                        ...
                                                                        <Table className="table-sm align-items-center table-flush text-center mb-5" responsive>
                                                                        ...
                                                                        {r.tipo === 2 &&
                                                                            <div className="col-12 d-flex justify-content-between mx-auto">
                                                                                <strong className="ml-auto mr-4"><small>Total: S/. </small>{toSoles(r.total)}</strong>
                                                                            </div>
                                                                        }
                                                                    </Row>
                                                                </Collapse>
                            ...
                            <CardFooter className="py-4">
                                <nav aria-label="..." className="pagination justify-content-center mb-0">
                                    <PaginationComponent
